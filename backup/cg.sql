...
--
-- Host: localhost
-- Generation Time: Jun 27, 2016 at 11:08 PM
...
(81, 318971131, 'es', 0, 0, '2016-06-27 21:55:00', 0);
...
--
ALTER TABLE `cart`
MODIFY `cartEntryId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=113;
--
-- AUTO_INCREMENT for table `purchases`
--
ALTER TABLE `purchases`
MODIFY `purchaseEntryId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=82;
